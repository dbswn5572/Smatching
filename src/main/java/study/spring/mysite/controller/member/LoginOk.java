...
public class LoginOk {
	...
	public ModelAndView doRun(Locale locale, Model model, HttpServletRequest request, HttpServletResponse response) {
		...
		if (web.getSession("loginInfo") != null) {
			return web.redirect(web.getRootPath() + "/bbs/document_list.do?category=gallery", "이미 로그인 하셨습니다.");
		}
		...
		if (movePage == null) {
			movePage = web.getRootPath() + "/bbs/document_list.do?category=gallery";
		}
		return web.redirect(web.getRootPath() + "/bbs/document_list.do?category=gallery", null);
	}
}