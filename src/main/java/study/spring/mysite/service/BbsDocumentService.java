...
public interface BbsDocumentService {
	 ...
	 * @throws Exception
	 */
	public List<BbsDocument> selectDocumentListMypage(BbsDocument document) throws Exception;

	int selectDocumentCountMypage(BbsDocument document) throws Exception;
