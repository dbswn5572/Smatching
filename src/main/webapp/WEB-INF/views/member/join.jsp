...
<div class='container'>
    ...
    <form class="form-horizontal" name="myform" method="post"  enctype="multipart/form-data"
		...
		<div class="form-group">
            <label for='name' class="col-md-2">닉네임*</label>
            <div class="col-md-10">
        ...
        <div class="form-group">
            <label for='tel' class="col-md-2">인스타 아이디*</label>
            <div class="col-md-10">
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <input type="file" name="profile_img_path" id="profile_img_path" class="form-control"/> <!-- 여기 부분 한번 봐보자 -->
            </div>
        </div>
