...
<div class="container">
	...
	<div class="alert alert-info">
		<h3 style="margin: 0">
			...
			<small>
				<a href="${pageContext.request.contextPath}/bbs/document_list_mypage.do?category=gallery&memberId=${readDocument.memberId}&wname=${readDocument.writerName}">
	...
	<div class="clearfix">
		<div class="pull-right">
			...
			<a href="${pageContext.request.contextPath}/bbs/document_like.do?category=${category}&document_id=${readDocument.id}" class="btn btn-like">좋아요</a>
		</div>
	</div>
